...
import cm4mmupdater.listadapters.UpdateListAdapter;
import cm4mmupdater.misc.Constants;
import cm4mmupdater.misc.Log;
import cm4mmupdater.misc.State;
import cm4mmupdater.tasks.ChangelogTask;
import cm4mmupdater.tasks.MD5CheckerTask;
import cm4mmupdater.tasks.UpdateCheckTask;
import cm4mmupdater.tasks.ChangelogTask.ChangelogType;
import cm4mmupdater.utils.Preferences;
import cm4mmupdater.utils.StringUtils;
import cm4mmupdater.utils.SysUtils;
import cm4mmupdater.utils.UpdateFilter;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Resources res = getResources();
        setTitle(res.getString(R.string.app_name) + " - " + SysUtils.getModVersion());
        ...
        //Disable available roms button as we can't flash them directly anyway
//        Button btnExistingUpdates = (Button) findViewById(R.id.button_existing_updates);
//        btnExistingUpdates.setEnabled(false);
